...
=== Module Description ===
In this module, you will write a few different functions that operate on a Stack.
...
# TODO: implement this function, and complete its documentation!
# Refer to the lab handout for details
def list_stack(s: Stack, lst: List) -> None:
    """
    >>> s = Stack()
    >>> lst = [1, 3, 5]
    >>> list_stack(s, lst)
